...
public class AnalyseurSyntaxique implements SyntaxInterface {
   ...
   JTextArea codeTextArea;
    ...
    public AnalyseurSyntaxique(File fileACompiler) throws Exception{
    ...
    public void APPEL_FONCTION() throws Exception {
        switch (CODE_LEX_Cour){
            case ID_TOKEN:
                Test_Symbole(CODES_LEX.ID_TOKEN, ERR_SYNTAX.ID_ERR);
                APPEL_FONCTION2();
//                Test_Symbole(lexer.CODES_LEX.PO_TOKEN,parser.ERR_SYNTAX.PO_ERR);
//                ARGUMENT_LIST();
//                Test_Symbole(lexer.CODES_LEX.PF_TOKEN,parser.ERR_SYNTAX.PF_ERR);
                break;
            default:
...
//     if(CODE_LEX_Cour == lexer.CODES_LEX.ID_TOKEN){
//      VALUE();
//      VALUE_EPSILON();
//     }else if(CODE_LEX_Cour==lexer.CODES_LEX.NUM_TOKEN){
//      VALUE();
//      VALUE_EPSILON();
//     }else if(CODE_LEX_Cour==lexer.CODES_LEX.CAR_CONSTANTE){
//      VALUE();
//      VALUE_EPSILON();
//     }else if(CODE_LEX_Cour==lexer.CODES_LEX.CHAINE_CONSTANTE){
//      VALUE();
//      VALUE_EPSILON();
//     }
    }
...
//     if(lexer.CODES_LEX.ID_TOKEN == CODE_LEX_Cour  || lexer.CODES_LEX.NUM_TOKEN ==CODE_LEX_Cour || lexer.CODES_LEX.PO_TOKEN==CODE_LEX_Cour){
//      EXPRESSION_STATEMENT();
//     }else if(CODE_LEX_Cour==lexer.CODES_LEX.SI_TOKEN || CODE_LEX_Cour==lexer.CODES_LEX.SELON_TOKEN){
//      CONDITIONAL_STATEMENT();
//     }else if(CODE_LEX_Cour==lexer.CODES_LEX.TANT_QUE_TOKEN || CODE_LEX_Cour==lexer.CODES_LEX.POUR_TOKEN || CODE_LEX_Cour==lexer.CODES_LEX.REPETER_TOKEN){
//      LOOP_STATEMENT();
//     }else if(lexer.CODES_LEX.RETOURNER_TOKEN == CODE_LEX_Cour){
//      RETURN_STATEMENT();
//     }else{
//      //ERROR(courant, parser.ERR_SYNTAX.STATEMENT_ERR);
//     }
    }
